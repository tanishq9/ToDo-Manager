...
$(function(){
    ...
    addtodo.click(function(){
        ...
        // AJAX : Async Javascrsipt and XML
        ...
        $.post(
            ...
            function(data){ 
                // in routes/todos.js,check in post request,we are sending the whole todo list as response
                // this is the callback function which is called after we receive the response , which is the data
                // this data is an array of all the tasks whose size keeps on increasing
...
// append , empty are jquery functions